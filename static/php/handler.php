...
// ваш Email
$admin_mail = 'love@aruna-craft.com';
...
<body>
    ...
    В скором времени с Вами свяжется наш менеджер.</p>
	<ul>
...
$headers[] = 'From: Aruna-craft - подарки из стекла <noreply@aruna-craft.com>'; // От кого
